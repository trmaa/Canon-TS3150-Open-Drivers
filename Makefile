#############################################################################
# Makefile for building: impresora
# Generated by qmake (3.1) (Qt 5.15.17)
# Project:  impresora.pro
# Template: app
# Command: /sbin/qmake-qt5 -o Makefile impresora.pro
#############################################################################
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /sbin/qmake-qt5 -install qinstall
QINSTALL_PROGRAM = /sbin/qmake-qt5 -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = impresora1.0.0
DISTDIR = /home/pablo/impresora/.tmp/impresora1.0.0
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		impresora.pro  main.cpp
QMAKE_TARGET  = impresora
DESTDIR       = 
TARGET        = impresora
...
Makefile: impresora.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		impresora.pro
	$(QMAKE) -o Makefile impresora.pro
...
main.moc: main.cpp \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/pablo/impresora/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/pablo/impresora -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/15.1.1 -I/usr/include/c++/15.1.1/x86_64-pc-linux-gnu -I/usr/include/c++/15.1.1/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/15.1.1/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/15.1.1/include-fixed -I/usr/include main.cpp -o main.moc
